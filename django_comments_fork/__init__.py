...
from django_comments_fork.models import Comment
from django_comments_fork.forms import CommentForm

DEFAULT_COMMENTS_APP = 'django_comments_fork'


def get_comment_app():
    """
    Get the comment app (i.e. "django_comments_fork") as defined in the settings
    """
...
def get_form_target():
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_form_target"):
        ...
        return urlresolvers.reverse("django_comments_fork.views.comments.post_comment")
...
def get_flag_url(comment):
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_flag_url"):
        ...
        return urlresolvers.reverse("django_comments_fork.views.moderation.flag",
                                    args=(comment.id,))
...
def get_delete_url(comment):
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_delete_url"):
        ...
        return urlresolvers.reverse("django_comments_fork.views.moderation.delete",
                                    args=(comment.id,))
...
def get_approve_url(comment):
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_approve_url"):
        ...
        return urlresolvers.reverse("django_comments_fork.views.moderation.approve",
                                    args=(comment.id,))
