...
class Moderator(object):
    ...
    def connect(self):
        ...
        """
        signals.comment_will_be_posted.connect(self.pre_save_moderation, sender=django_comments_fork.get_model())
        signals.comment_was_posted.connect(self.post_save_moderation, sender=django_comments_fork.get_model())
